...
cp "$MODULE_DIRECTORY/ulxqt-signing/policy.json" $CONTAINER_DIR/policy.json
cp "$MODULE_DIRECTORY/ulxqt-signing/policy.json" $ETC_CONTAINER_DIR/policy.json
...
sed -i "s ghcr.io/IMAGENAME $IMAGE_REGISTRY g" "$MODULE_DIRECTORY/ulxqt-signing/registry-config.yaml"
cp "$MODULE_DIRECTORY/ulxqt-signing/registry-config.yaml" "$CONTAINER_DIR/registries.d/$IMAGE_REGISTRY_TITLE.yaml"
cp "$MODULE_DIRECTORY/ulxqt-signing/registry-config.yaml" "$ETC_CONTAINER_DIR/registries.d/$IMAGE_REGISTRY_TITLE.yaml"
rm "$MODULE_DIRECTORY/ulxqt-signing/registry-config.yaml"
